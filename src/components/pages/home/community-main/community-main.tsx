      ...
      <div className="container mx-auto px-6 py-32">
        ...
        <div className="font-items flex flex-col items-center pt-10 relative text-left">
          ...
          <Item>
            ...
            <b>Phoenix is the key solution</b> to ensure a sustainable, fair and
            smooth way to raise the required capital while Phoenix handles all
            the tracking and compensation.
          </Item>
          <Item>
            The link to the <b>application form</b> for projects and startups is
            located on the bottom of the website.
          </Item>
        </div>
      </div>
    </section>
