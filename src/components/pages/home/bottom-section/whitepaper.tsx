import Arrow from "@public/pages/home/up-left-arrow.svg";

export const Whitepaper = (props: { text: string; link?: string }) => {
  return (
    <a className="w-[100%] hover:w-[101%]" href={props.link} target="_blank">
